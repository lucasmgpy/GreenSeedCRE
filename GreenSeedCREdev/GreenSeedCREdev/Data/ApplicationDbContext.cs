...
namespace GreenSeedCREdev.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //define composite key and relatioships for CategoryProducts
            ...
            modelBuilder.Entity<CategoryProduct>().HasData(
                ...
                new CategoryProduct { CategoryId = 2, ProductId = 2 },
                new CategoryProduct { CategoryId = 3, ProductId = 3 },
                new CategoryProduct { CategoryId = 2, ProductId = 4 },
                new CategoryProduct { CategoryId = 3, ProductId = 5 },
                new CategoryProduct { CategoryId = 3, ProductId = 6 },
                new CategoryProduct { CategoryId = 4, ProductId = 7 },
                new CategoryProduct { CategoryId = 4, ProductId = 8 },
                new CategoryProduct { CategoryId = 5, ProductId = 9 },
                new CategoryProduct { CategoryId = 5, ProductId = 10 }
                );
        }
    }
}
